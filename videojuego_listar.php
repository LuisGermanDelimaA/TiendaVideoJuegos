...
<body id="page-top">
  ...
  <div id="wrapper">
   ...
   ?>
    ...
    <form method="POST" action="modulos/CrudVideojuego.php" accept-charset="UTF-8" id="editarForm" enctype="multipart/form-data" onsubmit="return true">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-2" style="display: inline-flex">
              <div class="page-title">
                  <h5 class="m-0 font-weight-bold text-primary"> Listado de Video juegos </h5>
              </div>
              <div class="lista_btn">
                
                  <a id="btn_crear_nuevo" class="btn btn-secundario " href="videojuego_editar.php" title="Crear Nuevo">
                          ...
                          <table class="table table-bordered table-striped table-hover dataTable" id="tabla_personas" style="width:100%">
                              ...
                              <tbody id="">
                                ...
                                <tr role="row">
                                      ...
                                      <td><a href="videojuego_editar.php?id=<?php echo $val['id'] ?>"> <?php echo $val['id'] ?></a> </td>
                                      <td><?php echo $val['titulo'] ?></td>
                                      <td><?php echo $val['categoria'] ?></td>
                                      <td><?php echo $val['protagonista'] ?></td>
                                      <td><?php echo $val['director'] ?></td>
                                      <td><?php echo $val['productor'] ?></td>
                                      <td><?php echo $val['tecnologia'] ?></td>
                                      <td><?php echo $val['descripcion'] ?></td>
                                      <td><?php echo $val['anio'] ?></td>
                                      <td><?php echo $val['precio'] ?></td>
                                      <td><?php echo $val['disponibilidad'] ?></td>
                                  </tr>
                                <?php 
                                  }
                                ?>
